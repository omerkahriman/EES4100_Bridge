...
static pthread_mutex_t timer_lock = PTHREAD_MUTEX_INITIALIZER;	/*initialise timer lock */

/*Add object to link list*/
static void add_to_list(word_object ** list_head, uint16_t number)
{
